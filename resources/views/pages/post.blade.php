                ...
                <div class="single-post summary  "> <!-- bg-white -->
                    <div class="single-post-title">
                        ...
                        <div class="post-meta list-color-general mb-4">
                            ...
                            <a href="#"><i class="flaticon-calendar flat-mini"></i> <span>{{date('d/m/Y',strtotime($post->created_at))}}</span></a>
                            <!-- <a href="#"><i class="flaticon-comments flat-mini"></i> <span>02</span></a> -->
                            <!-- <a href="#"><i class="flaticon-like flat-mini"></i> <span>30</span></a> -->
                            <a href="#"><i class="flaticon-eye-1 flat-mini"></i> <span>{{$post->Post->hits}}</span></a>
                ...
                <div class="blog-sidebar widget-box-model">
                    ...
                    <div class="widget widget_recent_property">
                        ...
                        <ul>
                            ...
                            <li>
                                <img src="data/news/{{$val->Post->img}}" alt="">
                                <div class="thumb-body">
                                    <h6 class="listing-title"><a href="{{$catslug}}/{{$val->Post->slug}}">{{$val->name}}</a></h6>
                                </div>
                            </li>
                            @endforeach
                        </ul>
